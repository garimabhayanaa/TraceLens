...
=======
    ...
    def get_user_sessions(user_id: str, limit: int = 10) -> Dict[str, Any]:
        ...
        try:
            # Use the filter() method instead of where() with positional arguments
            sessions_ref = db.collection('analysis_sessions')
            query = sessions_ref.filter('user_id', '==', user_id).limit(limit)
    ...
    def cleanup_expired_sessions() -> Dict[str, Any]:
        ...
        try:
            ...
            expired_sessions = db.collection('analysis_sessions').filter(
...
class AuditLog:
    ...
    def get_user_logs(user_id: str, limit: int = 50) -> Dict[str, Any]:
        ...
        try:
            ...
            query = logs_ref.filter('user_id', '==', user_id).limit(limit)
...
__all__ = ['FirestoreUser', 'AnalysisSession', 'AuditLog', 'db']
>>>>>>> Stashed changes
