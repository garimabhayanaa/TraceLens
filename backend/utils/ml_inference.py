...
class MLInferencePipeline:
    ...
    def initialize_ml_models(self):
        ...
        if TRANSFORMERS_AVAILABLE:
            try:
                ...
                # Zero-shot classification for interests
                self.interest_classifier = pipeline(
        ...
        # Fallback to rule-based methods if ML models not available
    ...
    def _infer_interests(self, text: str) -> dict:
        ...
        if self.ml_models_loaded:
            try:
                result = self.interest_classifier(text[:512], self.interest_categories)
                interests = []
    ...
    def _analyze_social_patterns(self, text: str) -> dict:
        ...
        elif social_indicators['community_references'] + social_indicators['collaborative_language'] > social_indicators['individual_focus']:
            social_orientation = 'community_oriented'
        elif social_indicators['individual_focus'] > social_indicators['other_focus'] + social_indicators['community_references']:
